...
from langchain_core.runnables import RunnablePassthrough # 데이터를 전달하는 역할을 합니다. 이 클래스는 invoke() 메서드를 통해 입력된 데이터를 그대로 반환
...
retriever = store.as_retriever(search_kwargs={"k":5}) # 유사도 기준 상위 3개의 문서를 
# k-th
