...
app.config['UPLOAD_FOLDER'] = '6.Flask/2.templates/templates/uploads'
# ALLOWED_FILE_EXT = ['png', 'jpg', 'jpeg', 'gif', 'png'] # 리스트
app.config['ALLOWED_FILE_EXT']= {'png', 'jpg', 'jpeg', 'gif', 'png'} # set - 유닉한 리스트 (위의 리스트와 기능은 동일하지만 좀 더 파이썬 스러운(pythonic) 자료구조임)
app.config['MAX_CONTENT_LENGTH'] = 1* 1024*1024 # 1MB 넘으면 flask가 에러 발생시키니까 용량을 체크하는 함수나 기능을 만들필요없음
...
def too_large(e):
    size_mb = app.config['MAX_CONTENT_LENGHTH'] / (1024*1024)
